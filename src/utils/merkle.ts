...
/**
 * Given an address list, build the Merkle tree
...
/**
 * Fetch the channel's allowlist from IPFS (via merkle_uri),
 * build the tree, and compute a proof for the given address.
