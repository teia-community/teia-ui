...
export const DAO = () => {
  ...
  return (
    <Page title="Claim DAO tokens" large>
      ...
      <div className={styles.dao__outer__container}>
        <p> 
          Here, you can claim your TEIA DAO tokens. If your Tezos wallet satisfies the conditions laid out in the token distribution fact sheet you are eligible to claim your Teia Tokens. You can find a Table with all eligible Tezos addresses here [add link]. TEIA DAO tokens, or TEIA Tokens, are specifically designed for governance purposes within the Teia DAO ecosystem: By owning TEIA Tokens, you are part of the Teia DAO LLC and eligible to put forward and vote on DAO Proposals for Teia. TEIA Tokens are not intended to be securities or investment instruments and Teia as a non-profit organisation is not allowed and does not intend to generate and distribute Profits based on Token ownership.
        </p> 
        <p> 
      ...
      <div className={styles.dao__outer__container}>
        <h2 className={styles.dao__title}>How to Claim your Tokens</h2>
        <ol>
        ...
        <p>
          For any questions or assistance regarding the token claim process, please contact us via discord or mail at info@teia.art
        </p>
      </div>
      ...
      <div className={styles.dao__outer__container}>        
        ...
        <p>
          By clicking this button, you confiorm that you have read and agree with the legal disclaimer below
        </p>
      </div>
      ...
      <div className={styles.dao__outer__container}>
        ...
        <p>
          Please read the following disclaimer carefully before participating in the TEIA Token Claim process. By claiming your TEIA DAO tokens, you agree to be bound by the terms and conditions set forth in this disclaimer. If you do not agree with any part of this disclaimer, you should refrain from using this Claim Page.
        </p>
        <ol>
