...
export const FullScreenEnterIcon = withIcon(`
<svg viewBox="0 0 14 14">
  <path d="M0 11h3v3h2V9H0v2Zm3-8H0v2h5V0H3v3Zm6 11h2v-3h3V9H9v5Zm2-11V0H9v5h5V3h-3Z"/>
</svg>`)

export const FullScreenExitIcon = withIcon(`
<svg viewBox="0 0 14 14">
  <path fill="var(--text-color)" d="M2 9H0v5h5v-2H2V9ZM0 5h2V2h3V0H0v5Zm12 7H9v2h5V9h-2v3ZM9 0v2h3v3h2V0H9Z"/>
</svg>`)
