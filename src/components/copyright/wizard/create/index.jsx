  ...
  if (!customLicenseData?.tokens?.length) {
    return (
      <div className={styles.container}>
        ...
        <p>
          Please go back to the Edit tab and select tokens to create a copyright
          agreement.
        </p>
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.summary}>
        ...
        <div className={styles.section}>
          ...
          <ul className={styles.rightsList}>
            {customLicenseData.clauses.reproduce && (
              <li>✅ Right to Reproduce</li>
            )}
            {customLicenseData.clauses.broadcast && (
              <li>✅ Right to Broadcast</li>
            )}
            {customLicenseData.clauses.publicDisplay && (
              <li>✅ Right to Public Display</li>
            )}
            {customLicenseData.clauses.createDerivativeWorks && (
              <li>✅ Right to Create Derivative Works</li>
            )}
            {customLicenseData.clauses.requireAttribution && (
              <li>✅ Attribution Required</li>
            )}
            {customLicenseData.clauses.rightsAreTransferable && (
              <li>✅ Rights Are Transferable</li>
            )}
            {customLicenseData.clauses.releasePublicDomain && (
              <li>✅ Released to Public Domain</li>
            )}
      ...
      <div className={styles.actions}>
        <Button
          onClick={() => navigate('/copyright/preview')}
          disabled={isSubmitting}
        >
          Back to Preview
        </Button>

        <Button onClick={handleSubmit} disabled={isSubmitting} shadow_box>
          {isSubmitting
            ? 'Submitting...'
            : 'Create & Submit Copyright Agreement'}
        </Button>
      </div>
