...
/**
 * Helper route at /messages/dm/:address — finds the existing DM channel
 * with this peer (if any) and redirects there; otherwise sends the user
 * to the create-channel flow with the recipient pre-filled.
 */
