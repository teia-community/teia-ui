...
- We want to reach a parity in voice and contribution between people from all communities and sorts of priviledges and global south. This needs to be reached through concrete action and leveraging power
...
We believe in shared ownership on the platform, no one should have exclusive rights over others. However, we acknowledge that our platform is not fully decentralised yet. The process of getting towards full decentralisation will be long and needs the utmost prudence to be fair and in line with the vision of TEIA.
...
- Infringed copyright: the use of artists' work in part or whole where the artist explicitly forbids 3rd party use.
